...
Source Server         : ENCUESTA_CAP_WEBINEI
Source Server Version : 50173
Source Host           : 192.168.200.79:3306
Source Database       : encuesta_cap

Target Server Type    : MYSQL
Target Server Version : 50173
File Encoding         : 65001

Date: 2015-10-06 22:05:46
*/
...
INSERT INTO `cursos` VALUES ('10', 'Análisis de Indicadores y elaboración de reportes ', '1', '1');
...
INSERT INTO `cursos` VALUES ('13', 'Construcción e Interpretación de Indicadores Económicos y Sociales', '1', '2');
...
INSERT INTO `cursos` VALUES ('21', 'Herramientas Ofimáticas (Excel, Word, Power Point, Project, Publisher)', '1', '4');
...
INSERT INTO `cursos` VALUES ('24', 'Macros en Excel para Análisis de Información Estadistica', '1', '4');
...
INSERT INTO `cursos` VALUES ('29', 'Especialización Construccion de Indicadores Económicas y Sociales', '1', '5');

-- ----------------------------
-- Table structure for `cursos_has_datos_personales`
-- ----------------------------
DROP TABLE IF EXISTS `cursos_has_datos_personales`;
CREATE TABLE `cursos_has_datos_personales` (
  `id_cursos` int(11) NOT NULL,
  `id_persona` int(11) NOT NULL,
  PRIMARY KEY (`id_cursos`,`id_persona`),
  KEY `fk_cursos_has_datos_personales_datos_personales1_idx` (`id_persona`),
  KEY `fk_cursos_has_datos_personales_cursos1_idx` (`id_cursos`),
  CONSTRAINT `fk_cursos_has_datos_personales_cursos1` FOREIGN KEY (`id_cursos`) REFERENCES `cursos` (`id_cursos`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_cursos_has_datos_personales_datos_personales1` FOREIGN KEY (`id_persona`) REFERENCES `datos_personales` (`id_persona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of cursos_has_datos_personales
-- ----------------------------
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '5');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '6');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '6');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '6');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '6');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '6');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '7');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '10');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '11');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '14');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '14');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '14');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '14');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '14');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '14');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '16');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '16');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '16');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '17');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '17');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '17');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '17');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '17');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '17');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '20');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '22');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '23');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '23');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '23');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '23');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '25');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '25');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '25');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '25');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '25');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '25');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '26');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '26');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '27');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '27');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '27');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '27');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '27');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '29');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '30');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '30');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '30');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '30');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('27', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '31');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '33');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '33');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '33');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '33');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '33');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '34');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '34');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '35');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '35');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '35');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '35');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '35');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '36');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '36');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '37');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '37');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '37');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '37');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '37');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '39');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('27', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '41');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '42');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '42');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '42');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '42');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '42');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '43');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '43');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '43');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '43');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '43');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('27', '44');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '45');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '53');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('7', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('8', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('27', '54');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('3', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('15', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('19', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('27', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '58');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('9', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('12', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '60');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('5', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('16', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('18', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('24', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('27', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('29', '61');
INSERT INTO `cursos_has_datos_personales` VALUES ('2', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('6', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('11', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('14', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('26', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '62');
INSERT INTO `cursos_has_datos_personales` VALUES ('21', '64');
INSERT INTO `cursos_has_datos_personales` VALUES ('22', '64');
INSERT INTO `cursos_has_datos_personales` VALUES ('23', '64');
INSERT INTO `cursos_has_datos_personales` VALUES ('25', '64');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '64');
INSERT INTO `cursos_has_datos_personales` VALUES ('4', '65');
INSERT INTO `cursos_has_datos_personales` VALUES ('10', '65');
INSERT INTO `cursos_has_datos_personales` VALUES ('13', '65');
INSERT INTO `cursos_has_datos_personales` VALUES ('17', '65');
INSERT INTO `cursos_has_datos_personales` VALUES ('20', '65');
INSERT INTO `cursos_has_datos_personales` VALUES ('28', '65');
...
CREATE TABLE `datos_personales` (
  ...
  `idinstituciones_publicas` int(11) DEFAULT NULL,
  `area` varchar(45) DEFAULT NULL,
  `sugerencias` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id_persona`),
  KEY `fk_datos_personales_ubdistrito1_idx` (`idDist`),
  KEY `fk_datos_personales_instituciones_publicas1_idx` (`idinstituciones_publicas`),
  CONSTRAINT `fk_datos_personales_instituciones_publicas1` FOREIGN KEY (`idinstituciones_publicas`) REFERENCES `instituciones_publicas` (`idinstituciones_publicas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_datos_personales_ubdistrito1` FOREIGN KEY (`idDist`) REFERENCES `ubdistrito` (`idDist`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of datos_personales
-- ----------------------------
INSERT INTO `datos_personales` VALUES ('5', 'JEsus rolando', 'claros', 'tapia', 'JESUS.CLAROS@INEI.GOB.PE', '', '941133985', '33', '2', '1275', '192', 'CUENTAS NACIONALES', '');
INSERT INTO `datos_personales` VALUES ('6', 'arlett vanessa', 'aguero', 'vargas', 'arliette81@hotmail.com', '', '956600794', '34', '1', '1251', '192', 'OTIN', 'Gestion de proyectos\r\ncobit\r\nbpm');
INSERT INTO `datos_personales` VALUES ('7', 'EDWIN HELAR', 'CHUMACERO', 'JIMENEZ', 'edwin.chumacero@inei.gob.pe', '', '994603221', '35', '2', '1251', '192', 'DNCE', '');
INSERT INTO `datos_personales` VALUES ('10', 'paola milagros', 'tenorio', 'ramirez', 'pamitera82@gmail.com', '', '', '33', '1', '1286', '192', 'DTDIS', 'Especializacion en spss (creacion y desarrollo de sintaxis)');
INSERT INTO `datos_personales` VALUES ('11', 'karen alexa', 'romero', 'jares', 'karenhina3@gmail.com', '', '', '33', '1', '1266', '192', 'censos y encuestas', 'por favor si podrían apertura cursos los sábados y domingos. :D');
INSERT INTO `datos_personales` VALUES ('14', 'alex', 'mamani', 'cordova', 'alex.mamani@inei.gob.pe', '', '992971172', '38', '2', '1251', '192', 'dnce', '');
INSERT INTO `datos_personales` VALUES ('16', 'paul randy', 'urbina', 'cuellar', 'paul.urbina@inei.gob.pe', '5348083', '949192867', '32', '2', '1285', '192', 'financiera', 'curso sobre contrataciones del estado ; sistema integrado de administracion financiera (siaf) ; cursos sobre flujos de caja ;  analisis e interpretacion de estados financieros.');
INSERT INTO `datos_personales` VALUES ('17', 'JORGE LUIS', 'CANGALAYA', 'Ramirez', 'jorge.cangalaya@inei.gob.pe', '', '950009536', '37', '2', '1255', '192', 'otd', 'Sistema siaf, siga, snip, contrataciones del estado');
INSERT INTO `datos_personales` VALUES ('20', 'jessica vaness', 'icaza', 'ponce de leon', 'jessylou_17@hotmail.com', '7963547', '985055515', '28', '1', '1265', '192', 'av. general garzón 654', '');
INSERT INTO `datos_personales` VALUES ('22', 'Alexander German', 'diaz', 'inga', 'alexander.diaz@inei.gob.pe', '3517031', '992443046', '34', '2', '1253', '192', 'Oficina técnica de difusión', '');
INSERT INTO `datos_personales` VALUES ('23', 'JOSE ENRIQUE', 'OYOLA', 'RAMIREZ', 'enrique.oyola@inei.gob.pe', '01', '3326997', '48', '2', '1263', '192', 'cENSOS Y ENCUESTAS', '');
INSERT INTO `datos_personales` VALUES ('25', 'santos', 'espinoza', 'torres', 'sespinoza@inei.gob.pe', '513900', '969232133', '58', '2', '1530', '192', 'ODEI PIURA', '');
INSERT INTO `datos_personales` VALUES ('26', 'nora zulema', 'tataje', 'povis', 'NZTP24@HOTMAIL.COM', '3478009', '976054682', '57', '1', '1265', '192', 'dnce', '');
INSERT INTO `datos_personales` VALUES ('27', 'LUIS ALBERTO ', 'MENDOZA', 'ALCANTARA', 'yoluis_20@hotmail.com', '', '976839199', '35', '2', '551', '192', 'oFICINA DEPARTAMENTAL', '');
INSERT INTO `datos_personales` VALUES ('29', 'felix nicolas', 'ruiz ', 'flores', 'felixruiz454@gmail.com', '5675808', '9680121112', '63', '2', '1263', '192', 'dnce-decg', '');
INSERT INTO `datos_personales` VALUES ('30', 'CESAR    ADOLFO', 'PANTOJA', 'OLAYA', 'cpantoja@inei.gob.pe', '', '991685873', '52', '2', '1265', '192', 'CENSOS  Y ENCUESTAS', '\r\n ---- curso para formación de metodólogos de encuestas.\r\n-------curso para formación de jefes de operación de campo de encuestas\r\n------PREZI  para presentación de resultados');
INSERT INTO `datos_personales` VALUES ('31', 'EILEEN PAMELA', 'PORTOCARRERO', 'ZAVALETA', 'EILEENPAMELA2@HOTMAIL.COM', '', '', '34', '1', '1', '192', 'AREA INFORMATICA', '');
INSERT INTO `datos_personales` VALUES ('33', 'JOSE ALBERTO', 'GARCIA', 'ZANABRIA', 'jose.garcia@inei.gob.pe', '2039275', '991685844', '60', '2', '1254', '192', 'INDICADORES ECONOMICOS', 'Modelos Economicos');
INSERT INTO `datos_personales` VALUES ('34', 'Michael John', 'Macavilca', 'mejia', 'Michael.Macavilca@inei.gob.pe', '', '935374814', '41', '2', '1267', '192', 'OTIN', 'LENGUAJE DE PROGRAMACION JAVA');
INSERT INTO `datos_personales` VALUES ('35', 'VICTOR ENRIQUE', 'bustamante', 'ramirez', 'victor.bustamante@inei.gob.pe', '', '943809651', '27', '2', '223', '192', 'informatica', '');
INSERT INTO `datos_personales` VALUES ('36', 'ELENA BEATRIZ', 'ORTIZ', 'PRADA', 'elena.ortiz@inei.gob.pe', '', '999928620', '0', '0', '1271', '192', 'oFICINA DE PERSONAL ', 'INGLÉS');
INSERT INTO `datos_personales` VALUES ('37', 'MILAGROS MARIA', 'GRANDA', 'CARRION', 'milaGROS.GRANDA@INEI.GOB.PE', '6226145', '989141779', '40', '1', '1286', '192', 'DECG', 'SOFTWARE ARCGIS');
INSERT INTO `datos_personales` VALUES ('39', 'venturo', 'palomino', 'ancco', 'vpalomino71@gmail.com', '', '983686767', '44', '2', '250', '192', 'produccion estadistica', '');
INSERT INTO `datos_personales` VALUES ('41', 'PILAR', 'CHUQUIYAURI', 'COTRINA', 'pilar.chuquiauri@inei.gob.pe', '514002', '989100767', '29', '1', '887', '192', 'ESCUELA', 'SE SUGIERE TOMAR EN CUENTA EL DICTADO DE CURSOS DE ESPECIALIZACIÓN EN REDES, PROGRAMACIÓN EN ANDROID PARA TABLETS, PROGRAMACIÓN EN PHP-JAVA, MANEJO DEL SISTEMA OPERATIVO LINUX PARA AQUELLOS QUE EN MAYORÍA DE LAS OFICINAS PÚBLICAS Y PRIVADAS DESEMPEÑA');
INSERT INTO `datos_personales` VALUES ('42', 'Emerich edwin', 'barsallo', 'vasquez', 'embarsallo@hotmail.com', '', '979254703', '39', '2', '1213', '192', 'Av. balta 658', '');
INSERT INTO `datos_personales` VALUES ('43', 'gUIDO', 'VALENZUELA', 'YASALDE', '', '', '', '0', '0', '1283', '192', 'dtdis', 'mINERIA DE DATOS');
INSERT INTO `datos_personales` VALUES ('44', 'virna betty', 'ALVARADO ', 'CASTILLO', 'VIRNAB17@HOTMAIL.COM', '283757', '991686002', '37', '1', '1239', '192', 'ENAPRES', '');
INSERT INTO `datos_personales` VALUES ('45', 'CESAR ANTONIO', 'SAMAN', 'QUISPE', 'dj_saman@hotmail.com', '2802626', '962370445', '36', '2', '1293', '192', 'DIRECCIÓN TÉCNICA DE INDICADORES ECONÓMICOS', '');
INSERT INTO `datos_personales` VALUES ('53', 'miguel angel', 'solorzano', 'manrique', 'miguel_angel_101@hotmail.com', '043341879', '975763888', '29', '2', '223', '192', 'dnce', '');
INSERT INTO `datos_personales` VALUES ('54', 'EDGAR RAFAEL', 'RUGEL ', 'BARRETO', 'edgar.rugel@inei.gob.pe', '', '940203295', '27', '2', '84', '192', 'DTIE', 'CURSOS DE MINERIA DE DATOS, O CIENCIA DE DATOS');
INSERT INTO `datos_personales` VALUES ('58', 'ROOSEWELT OTONIEL', 'LECCA', 'NUNEZ', 'roosewelt.lecca@inei.gob.pe', '', '958863539', '25', '2', '1422', '192', 'ODEI-LORETO', 'HERRAMINETAS ESTADISTICAS PARA LA RECOLECCION DE INFORMACION');
INSERT INTO `datos_personales` VALUES ('60', 'CARLOS', 'TIBURCIO', 'CORNELIO', 'CARLOS.TIBURCIO@INEI.GOB.PE', '514002', '962656379', '43', '2', '887', '192', 'ODEI-HUANUCO', '');
INSERT INTO `datos_personales` VALUES ('61', 'DUNIA ZULU', 'ROJAS ', 'ZETA', 'DUNIA.ROJAS@INEI.GOB.PE', '502276', '948147203', '40', '1', '1806', '192', 'INDICE DE PRECIOS AL CONSUMIDOR', '');
INSERT INTO `datos_personales` VALUES ('62', 'JAVIER ALEXANDER', 'ELIZALDE ', 'PULACHE', 'JAVIERCITO-ELI@HOTMAIL.COM', '', '958038274', '35', '2', '1806', '192', 'CHOFER', '');
INSERT INTO `datos_personales` VALUES ('64', 'GONZALO EMILIO', 'ANCHANTE', 'HURTADO', 'gonzalo.anchante@inei.gob.pe', '', '986789744', '38', '2', '1286', '192', 'ENEI', 'Balance scorecard');
INSERT INTO `datos_personales` VALUES ('65', 'silvia', 'caceres', 'palacios', 'scaceres_1@hotmail.com', '', '', '43', '1', '1271', '192', 'DTDIS', '');

-- ----------------------------
-- Table structure for `instituciones_publicas`
-- ----------------------------
DROP TABLE IF EXISTS `instituciones_publicas`;
CREATE TABLE `instituciones_publicas` (
  `idinstituciones_publicas` int(11) NOT NULL,
  `sector` varchar(45) DEFAULT NULL,
  `entidad` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idinstituciones_publicas`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of instituciones_publicas
-- ----------------------------
INSERT INTO `instituciones_publicas` VALUES ('1', ' AGRICULTURA', ' AUTORIDAD NACIONAL DEL AGUA (ANA)');
INSERT INTO `instituciones_publicas` VALUES ('2', ' AGRICULTURA', ' BANCO AGROPECUARIO (AGROBANCO)');
INSERT INTO `instituciones_publicas` VALUES ('3', ' AGRICULTURA', ' INSTITUTO NACIONAL DE INNOVACIÓN AGRARIA (INIA)');
INSERT INTO `instituciones_publicas` VALUES ('4', ' AGRICULTURA', ' MINISTERIO DE AGRICULTURA Y RIEGO (MINAGRI)');
INSERT INTO `instituciones_publicas` VALUES ('5', ' AGRICULTURA', ' PROGRAMA DE COMPENSACIONES PARA LA COMPETITIVIDAD (AGROIDEAS)');
INSERT INTO `instituciones_publicas` VALUES ('6', ' AGRICULTURA', ' PROGRAMA DE DESARROLLO PRODUCTIVO AGRARIO RURAL (AGRO RURAL)');
INSERT INTO `instituciones_publicas` VALUES ('7', ' AGRICULTURA', ' PROGRAMA SUBSECTORIAL DE IRRIGACIONES (PSI)');
INSERT INTO `instituciones_publicas` VALUES ('8', ' AGRICULTURA', ' PROYECTO DE INVESTIGACIÓN Y EXTENSIÓN AGRICOLA (INCAGRO)');
INSERT INTO `instituciones_publicas` VALUES ('9', ' AGRICULTURA', ' PROYECTO ESPECIAL ALTO HUALLAGA (PEAH)');
INSERT INTO `instituciones_publicas` VALUES ('10', ' AGRICULTURA', ' PROYECTO ESPECIAL BINACIONAL PUYANGO TUMBES (PEBPT)');
INSERT INTO `instituciones_publicas` VALUES ('11', ' AGRICULTURA', ' PROYECTO ESPECIAL DESARROLLO INTEGRAL DE LA CUENCA DEL RÍO PUTUMAYO (PEDICP)');
INSERT INTO `instituciones_publicas` VALUES ('12', ' AGRICULTURA', ' PROYECTO ESPECIAL JAÉN SAN IGNACIO BAGUA (PEJSIB)');
INSERT INTO `instituciones_publicas` VALUES ('13', ' AGRICULTURA', ' PROYECTO ESPECIAL PICHIS PALCAZU (PEPP)');
INSERT INTO `instituciones_publicas` VALUES ('14', ' AGRICULTURA', ' PROYECTO ESPECIAL SIERRA CENTRO SUR (MINAG-PESCS UE-1329)');
INSERT INTO `instituciones_publicas` VALUES ('15', ' AGRICULTURA', ' SERVICIO NACIONAL DE SANIDAD AGRARIA DEL PERÚ (SENASA)');
INSERT INTO `instituciones_publicas` VALUES ('16', ' AGRICULTURA', ' SERVICIO NACIONAL FORESTAL Y DE FAUNA SILVESTRE (SERFOR)');
INSERT INTO `instituciones_publicas` VALUES ('17', ' COMERCIO EXTERIOR Y TURISMO', ' CENTRO DE FORMACIÓN EN TURISMO (CENFOTUR)');
INSERT INTO `instituciones_publicas` VALUES ('18', ' COMERCIO EXTERIOR Y TURISMO', ' COMISIÓN DE PROMOCIÓN DEL PERÚ PARA LA EXPORTACIÓN Y EL TURISMO (PROMPERÚ)');
INSERT INTO `instituciones_publicas` VALUES ('19', ' COMERCIO EXTERIOR Y TURISMO', ' MINISTERIO DE COMERCIO EXTERIOR Y TURISMO (MINCETUR)');
INSERT INTO `instituciones_publicas` VALUES ('20', ' TRANSPORTES Y COMUNICACIONES', ' AUTORIDAD AUTÓNOMA DEL SISTEMA ELÉCTRICO DE TRANSPORTE MASIVO DE LIMA Y CALLAO (AATE)');
INSERT INTO `instituciones_publicas` VALUES ('21', ' TRANSPORTES Y COMUNICACIONES', ' AUTORIDAD PORTUARIA NACIONAL (APN)');
INSERT INTO `instituciones_publicas` VALUES ('22', ' TRANSPORTES Y COMUNICACIONES', ' CORPORACIÓN PERUANA DE AEROPUERTOS Y AVIACIÓN COMERCIAL S.A. (CORPAC S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('23', ' TRANSPORTES Y COMUNICACIONES', ' DIRECCION REGIONAL DE TRANSPORTES Y COMUNICACIONES - ANCASH (DRTC - ANCASH)');
INSERT INTO `instituciones_publicas` VALUES ('24', ' TRANSPORTES Y COMUNICACIONES', ' EMPRESA NACIONAL DE PUERTOS S.A. (ENAPU S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('25', ' TRANSPORTES Y COMUNICACIONES', ' FONDO DE INVERSIÓN EN TELECOMUNICACIONES (FITEL)');
INSERT INTO `instituciones_publicas` VALUES ('26', ' TRANSPORTES Y COMUNICACIONES', ' MINISTERIO DE TRANSPORTES Y COMUNICACIONES (MTC)');
INSERT INTO `instituciones_publicas` VALUES ('27', ' TRANSPORTES Y COMUNICACIONES', ' PROYECTO ESPECIAL DE INFRAESTRUCTURA DE TRANSPORTE DESCENTRALIZADO (PROVIAS DESCENTRALIZ)');
INSERT INTO `instituciones_publicas` VALUES ('28', ' TRANSPORTES Y COMUNICACIONES', ' PROYECTO ESPECIAL DE INFRAESTRUCTURA DE TRANSPORTE NACIONAL (PROVIAS NACIONAL)');
INSERT INTO `instituciones_publicas` VALUES ('29', ' TRANSPORTES Y COMUNICACIONES', ' SERVICIOS POSTALES DEL PERÚ S.A. (SERPOST S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('30', ' TRANSPORTES Y COMUNICACIONES', ' SUPERINTENDENCIA DE TRANSPORTE TERRESTRE DE PERSONAS, CARGA Y MERCANCIAS (SUTRAN)');
INSERT INTO `instituciones_publicas` VALUES ('31', ' PRODUCCIÓN', ' FONDO NACIONAL DE DESARROLLO PESQUERO (FONDEPES)');
INSERT INTO `instituciones_publicas` VALUES ('32', ' PRODUCCIÓN', ' INSTITUTO DEL MAR DEL PERÚ (IMARPE)');
INSERT INTO `instituciones_publicas` VALUES ('33', ' PRODUCCIÓN', ' INSTITUTO NACIONAL DE CALIDAD (INACAL)');
INSERT INTO `instituciones_publicas` VALUES ('34', ' PRODUCCIÓN', ' INSTITUTO TECNOLÓGICO DE LA PRODUCCIÓN (ITP)');
INSERT INTO `instituciones_publicas` VALUES ('35', ' PRODUCCIÓN', ' MINISTERIO DE LA PRODUCCIÓN (PRODUCE)');
INSERT INTO `instituciones_publicas` VALUES ('36', ' PRODUCCIÓN', ' PROGRAMA NACIONAL DE INNOVACIÓN PARA LA COMPETITIVIDAD Y PRODUCTIVIDAD (PNICP)');
INSERT INTO `instituciones_publicas` VALUES ('37', ' ENERGÍA Y MINAS', ' ACTIVOS MINEROS S.A.C (AMSAC)');
INSERT INTO `instituciones_publicas` VALUES ('38', ' ENERGÍA Y MINAS', ' ELECTRO PUNO S.A.A. (ELPU)');
INSERT INTO `instituciones_publicas` VALUES ('39', ' ENERGÍA Y MINAS', ' EMPRESA CONCESIONARIA DE ELECTRICIDAD DE UCAYALI S.A. (ELECTRO UCAYALI S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('40', ' ENERGÍA Y MINAS', ' EMPRESA DE ADMINISTRACIÓN DE INFRAESTRUCTURA ELÉCTRICA S.A. (ADINELSA)');
INSERT INTO `instituciones_publicas` VALUES ('41', ' ENERGÍA Y MINAS', ' EMPRESA DE ELECTRICIDAD DEL PERÚ S.A. (ELECTROPERU)');
INSERT INTO `instituciones_publicas` VALUES ('42', ' ENERGÍA Y MINAS', ' EMPRESA DE GENERACIÓN ELÉCTRICA DE AREQUIPA S.A. (EGASA)');
INSERT INTO `instituciones_publicas` VALUES ('43', ' ENERGÍA Y MINAS', ' EMPRESA DE GENERACIÓN ELÉCTRICA DEL SUR S.A. (EGESUR)');
INSERT INTO `instituciones_publicas` VALUES ('44', ' ENERGÍA Y MINAS', ' EMPRESA DE GENERACIÓN ELÉCTRICA MACHUPICCHU S.A. (EGEMSA)');
INSERT INTO `instituciones_publicas` VALUES ('45', ' ENERGÍA Y MINAS', ' EMPRESA DE GENERACIÓN ELÉCTRICA SAN GABÁN S.A. (SAN GABAN S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('46', ' ENERGÍA Y MINAS', ' EMPRESA DE SERVICIO PÚBLICO DE ELECTRICIDAD DEL NOR OESTE DEL PERÚ S.A. (ELECTRONOROESTE)');
INSERT INTO `instituciones_publicas` VALUES ('47', ' ENERGÍA Y MINAS', ' EMPRESA DE SERVICIO PÚBLICO DE ELECTRICIDAD ELECTRO NORTE MEDIO S.A - HIDRANDINA (HIDRANDINA)');
INSERT INTO `instituciones_publicas` VALUES ('48', ' ENERGÍA Y MINAS', ' EMPRESA MINERA DEL CENTRO DEL PERÚ S.A. (CENTROMIN)');
INSERT INTO `instituciones_publicas` VALUES ('49', ' ENERGÍA Y MINAS', ' EMPRESA REGIONAL DE SERVICIO PUBLICO DE ELECTRICIDAD DEL CENTRO S.A. (ELECTROCENTRO)');
INSERT INTO `instituciones_publicas` VALUES ('50', ' ENERGÍA Y MINAS', ' EMPRESA REGIONAL DE SERVICIO PÚBLICO DE ELECTRICIDAD DEL NORTE S.A (ELECTRONORTE S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('51', ' ENERGÍA Y MINAS', ' EMPRESA REGIONAL DE SERVICIO PÚBLICO DE ELECTRICIDAD DEL ORIENTE S.A. (ELECTRO ORIENTE)');
INSERT INTO `instituciones_publicas` VALUES ('52', ' ENERGÍA Y MINAS', ' EMPRESA REGIONAL DE SERVICIO PÚBLICO DE ELECTRICIDAD DEL SUR ESTE S.A.A. (ELSE)');
INSERT INTO `instituciones_publicas` VALUES ('53', ' ENERGÍA Y MINAS', ' EMPRESA REGIONAL DE SERVICIO PÚBLICO DE ELÉCTRICIDAD DEL SUR S.A. (ELECTROSUR S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('54', ' ENERGÍA Y MINAS', ' INSTITUTO GEOLÓGICO MINERO Y METALÚRGICO (INGEMMET)');
INSERT INTO `instituciones_publicas` VALUES ('55', ' ENERGÍA Y MINAS', ' INSTITUTO PERUANO DE ENERGÍA NUCLEAR (IPEN)');
INSERT INTO `instituciones_publicas` VALUES ('56', ' ENERGÍA Y MINAS', ' MINISTERIO DE ENERGÍA Y MINAS (MEM)');
INSERT INTO `instituciones_publicas` VALUES ('57', ' ENERGÍA Y MINAS', ' PERUPETRO S.A. (PERUPETRO)');
INSERT INTO `instituciones_publicas` VALUES ('58', ' ENERGÍA Y MINAS', ' PETRÓLEOS DEL PERÚ (PETROPERU)');
INSERT INTO `instituciones_publicas` VALUES ('59', ' ENERGÍA Y MINAS', ' SOCIEDAD ELÉCTRICA DEL SUR OESTE S.A. (SEAL)');
INSERT INTO `instituciones_publicas` VALUES ('60', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' CENTRO NACIONAL DE SALUD RENAL (CNSR)');
INSERT INTO `instituciones_publicas` VALUES ('61', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' GERENCIA CENTRAL DE LOGISTICA (GCL - ESSALUD)');
INSERT INTO `instituciones_publicas` VALUES ('62', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' INSTITUTO NACIONAL DEL CORAZON (INCOR - ESSALUD)');
INSERT INTO `instituciones_publicas` VALUES ('63', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' MINISTERIO DE TRABAJO Y PROMOCIÓN DEL EMPLEO (MTPE)');
INSERT INTO `instituciones_publicas` VALUES ('64', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' OFICINA DE SELECCION PROMOCION Y CARRERA (OSPC - ESSALUD)');
INSERT INTO `instituciones_publicas` VALUES ('65', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' PROGRAMA NACIONAL DE EMPLEO JUVENIL JOVENES PRODUCTIVOS (JOVENES PRODUCTIVOS)');
INSERT INTO `instituciones_publicas` VALUES ('66', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' PROGRAMA NACIONAL PARA LA PROMOCIÓN DE OPORTUNIDADES LABORALES (VAMOS PERÚ)');
INSERT INTO `instituciones_publicas` VALUES ('67', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' PROGRAMA PARA LA GENERACIÓN DE EMPLEO SOCIAL INCLUSIVO - TRABAJA PERÚ (TRABAJA PERÚ)');
INSERT INTO `instituciones_publicas` VALUES ('68', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL ALMENARA (RAA - ALMENARA)');
INSERT INTO `instituciones_publicas` VALUES ('69', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL AMAZONAS (DRAAM- AMAZONAS)');
INSERT INTO `instituciones_publicas` VALUES ('70', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL ANCASH (RA - ANCASH)');
INSERT INTO `instituciones_publicas` VALUES ('71', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL APURIMAC (RAC - APURIMAC)');
INSERT INTO `instituciones_publicas` VALUES ('72', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL AREQUIPA (RAAR - AREQUIPA)');
INSERT INTO `instituciones_publicas` VALUES ('73', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL CAJAMARCA (RA - CAJAMARCA)');
INSERT INTO `instituciones_publicas` VALUES ('74', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL CUSCO (RACU - CUSCO)');
INSERT INTO `instituciones_publicas` VALUES ('75', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL HUANCAVELICA (RAHVC - HUANCAVELICA)');
INSERT INTO `instituciones_publicas` VALUES ('76', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL HUANUCO (RAHU - HUANUCO)');
INSERT INTO `instituciones_publicas` VALUES ('77', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL ICA (RAICA)');
INSERT INTO `instituciones_publicas` VALUES ('78', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL JULIACA (RAJUL)');
INSERT INTO `instituciones_publicas` VALUES ('79', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL JUNIN (RAJUN)');
INSERT INTO `instituciones_publicas` VALUES ('80', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL LA LIBERTAD (RALI)');
INSERT INTO `instituciones_publicas` VALUES ('81', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL LAMBAYEQUE (RAL)');
INSERT INTO `instituciones_publicas` VALUES ('82', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL LORETO (RALO)');
INSERT INTO `instituciones_publicas` VALUES ('83', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL MADRE DE DIOS (RAMD)');
INSERT INTO `instituciones_publicas` VALUES ('84', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL MOQUEGUA (RAMOQ)');
INSERT INTO `instituciones_publicas` VALUES ('85', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL MOYOBAMBA (RAM- MOYOBAMBA)');
INSERT INTO `instituciones_publicas` VALUES ('86', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL PASCO (RAP - PASCO)');
INSERT INTO `instituciones_publicas` VALUES ('87', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL PIURA (RAPI- PIURA)');
INSERT INTO `instituciones_publicas` VALUES ('88', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL PUNO (RAPU- PUNO)');
INSERT INTO `instituciones_publicas` VALUES ('89', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL REBAGLIATI (RAR - REBAGLIATI)');
INSERT INTO `instituciones_publicas` VALUES ('90', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL SABOGAL (RAS - SABOGAL)');
INSERT INTO `instituciones_publicas` VALUES ('91', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL TACNA (RAT - TACNA)');
INSERT INTO `instituciones_publicas` VALUES ('92', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL TARAPOTO (RATAR - TARAPOTO)');
INSERT INTO `instituciones_publicas` VALUES ('93', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL TUMBES (RAT - TUMBES)');
INSERT INTO `instituciones_publicas` VALUES ('94', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' RED ASISTENCIAL UCAYALI (RAUC - UCAYALI)');
INSERT INTO `instituciones_publicas` VALUES ('95', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' SEGURO SOCIAL DE SALUD (ESSALUD)');
INSERT INTO `instituciones_publicas` VALUES ('96', ' TRABAJO Y PROMOCIÓN DEL EMPLEO', ' SUBGERENCIA DE PERSONAL (SGP- ESSALUD)');
INSERT INTO `instituciones_publicas` VALUES ('97', ' SALUD', ' AIS UTES PACASMAYO (HTL)');
INSERT INTO `instituciones_publicas` VALUES ('98', ' SALUD', ' DIRECCIÓN DE ABASTECIMIENTO DE RECURSOS ESTRATÉGICOS EN SALUD (DARES)');
INSERT INTO `instituciones_publicas` VALUES ('99', ' SALUD', ' DIRECCION DE RED DE SALUD LIMA CIUDAD (DRSLC)');
INSERT INTO `instituciones_publicas` VALUES ('100', ' SALUD', ' DIRECCIÓN DE RED DE SALUD LIMA NORTE V RÍMAC- SMP- LOS OLIVOS (RED DE SALUD RIMAC)');
INSERT INTO `instituciones_publicas` VALUES ('101', ' SALUD', ' DIRECCIÓN DE SALUD II LIMA SUR (DISA II L.S.)');
INSERT INTO `instituciones_publicas` VALUES ('102', ' SALUD', ' DIRECCIÓN DE SALUD IV LIMA ESTE (DISA IV LE)');
INSERT INTO `instituciones_publicas` VALUES ('103', ' SALUD', ' DIRECCION DE SALUD V LIMA CIUDAD (DISA V LC)');
INSERT INTO `instituciones_publicas` VALUES ('104', ' SALUD', ' DIRECCION RED DE SALUD - SAN JUAN DE MIRAFLORES - VILLA MARIA DEL TRIUNFO (DRS SJM VMT)');
INSERT INTO `instituciones_publicas` VALUES ('105', ' SALUD', ' E.S. II-1 HOSPITAL DE CHULUCANAS (ESHCHULUCANAS)');
INSERT INTO `instituciones_publicas` VALUES ('106', ' SALUD', ' HOSPITAL CARLOS LANFRANCO LA HOZ (HCLLH)');
INSERT INTO `instituciones_publicas` VALUES ('107', ' SALUD', ' HOSPITAL CAYETANO HEREDIA (HCH - MINSA)');
INSERT INTO `instituciones_publicas` VALUES ('108', ' SALUD', ' HOSPITAL DE BAJA COMPLEJIDAD VITARTE (HBCV)');
INSERT INTO `instituciones_publicas` VALUES ('109', ' SALUD', ' HOSPITAL DE EMERGENCIAS JOSÉ CASIMIRO ULLOA (HEJCU)');
INSERT INTO `instituciones_publicas` VALUES ('110', ' SALUD', ' HOSPITAL DE EMERGENCIAS PEDIÁTRICAS (HEP)');
INSERT INTO `instituciones_publicas` VALUES ('111', ' SALUD', ' HOSPITAL DE LA AMISTAD PERU-COREA II-2 SANTA ROSA (HAPCII-2-SRP)');
INSERT INTO `instituciones_publicas` VALUES ('112', ' SALUD', ' HOSPITAL HERMILIO VALDIZAN (HHV)');
INSERT INTO `instituciones_publicas` VALUES ('113', ' SALUD', ' HOSPITAL JOSÉ AGURTO TELLO DE CHOSICA (HJATCH)');
INSERT INTO `instituciones_publicas` VALUES ('114', ' SALUD', ' HOSPITAL MARÍA AUXILIADORA (HMA)');
INSERT INTO `instituciones_publicas` VALUES ('115', ' SALUD', ' HOSPITAL NACIONAL ARZOBISPO LOAYZA (HNAL)');
INSERT INTO `instituciones_publicas` VALUES ('116', ' SALUD', ' HOSPITAL NACIONAL DANIEL ALCIDES CARRION (HNDAC)');
INSERT INTO `instituciones_publicas` VALUES ('117', ' SALUD', ' HOSPITAL NACIONAL DOCENTE MADRE NIÑO SAN BARTOLOMÉ (HONADOMANI SB)');
INSERT INTO `instituciones_publicas` VALUES ('118', ' SALUD', ' HOSPITAL NACIONAL DOS DE MAYO (HNDM)');
INSERT INTO `instituciones_publicas` VALUES ('119', ' SALUD', ' HOSPITAL NACIONAL HIPOLITO UNANUE (HNHU)');
INSERT INTO `instituciones_publicas` VALUES ('120', ' SALUD', ' HOSPITAL NACIONAL SERGIO E. BERNALES (HNSEB - MINSA)');
INSERT INTO `instituciones_publicas` VALUES ('121', ' SALUD', ' HOSPITAL REGIONAL DOCENTE LAS MERCEDES (HRDLMCH)');
INSERT INTO `instituciones_publicas` VALUES ('122', ' SALUD', ' HOSPITAL REGIONAL ELEAZAR GUZMÁN BARRÓN (HEGB)');
INSERT INTO `instituciones_publicas` VALUES ('123', ' SALUD', ' HOSPITAL REGIONAL HERMILIO VALDIZAN MEDRANO - HUÁNUCO (HRHVM-HCO)');
INSERT INTO `instituciones_publicas` VALUES ('124', ' SALUD', ' HOSPITAL SAN JOSE DEL CALLAO (HOSPITAL SAN JOSE)');
INSERT INTO `instituciones_publicas` VALUES ('125', ' SALUD', ' HOSPITAL SAN JUAN DE LURIGANCHO (HSJL)');
INSERT INTO `instituciones_publicas` VALUES ('126', ' SALUD', ' HOSPITAL SANTA ROSA (HSR)');
INSERT INTO `instituciones_publicas` VALUES ('127', ' SALUD', ' HOSPITAL VICTOR LARCO HERRERA (HVLH)');
INSERT INTO `instituciones_publicas` VALUES ('128', ' SALUD', ' INSTITUTO DE GESTIÓN DE SERVICIOS DE SALUD (IGSS)');
INSERT INTO `instituciones_publicas` VALUES ('129', ' SALUD', ' INSTITUTO NACIONAL DE CIENCIAS NEUROLÓGICAS (INCN)');
INSERT INTO `instituciones_publicas` VALUES ('130', ' SALUD', ' INSTITUTO NACIONAL DE ENFERMEDADES NEOPLÁSICAS (INEN)');
INSERT INTO `instituciones_publicas` VALUES ('131', ' SALUD', ' INSTITUTO NACIONAL DE OFTALMOLOGÍA (INO)');
INSERT INTO `instituciones_publicas` VALUES ('132', ' SALUD', ' INSTITUTO NACIONAL DE REHABILITACIÓN (INR)');
INSERT INTO `instituciones_publicas` VALUES ('133', ' SALUD', ' INSTITUTO NACIONAL DE SALUD (INS)');
INSERT INTO `instituciones_publicas` VALUES ('134', ' SALUD', ' INSTITUTO NACIONAL DE SALUD DEL NIÑO (INSN)');
INSERT INTO `instituciones_publicas` VALUES ('135', ' SALUD', ' INSTITUTO NACIONAL DE SALUD MENTAL (INSMHDHN)');
INSERT INTO `instituciones_publicas` VALUES ('136', ' SALUD', ' INSTITUTO NACIONAL MATERNO PERINATAL (INMP)');
INSERT INTO `instituciones_publicas` VALUES ('137', ' SALUD', ' MINISTERIO DE SALUD (MINSA)');
INSERT INTO `instituciones_publicas` VALUES ('138', ' SALUD', ' PROGRAMA DE APOYO A LA REFORMA DEL SECTOR SALUD (PARSALUD II)');
INSERT INTO `instituciones_publicas` VALUES ('139', ' SALUD', ' RED ASISTENCIAL AYACUCHO - ESSALUD (RAAY)');
INSERT INTO `instituciones_publicas` VALUES ('140', ' SALUD', ' RED DE SALUD BARRANCO CHORRILLOS SURCO (RSS BCO.CHO.SCO.)');
INSERT INTO `instituciones_publicas` VALUES ('141', ' SALUD', ' RED DE SALUD VILLA EL SALVADOR LURIN PACHACAMAC PUCUSANA (RSS.VES.LPP)');
INSERT INTO `instituciones_publicas` VALUES ('142', ' SALUD', ' SEGURO INTEGRAL DE SALUD (SIS)');
INSERT INTO `instituciones_publicas` VALUES ('143', ' SALUD', ' SUPERINTENDENCIA NACIONAL DE SALUD (SUSALUD)');
INSERT INTO `instituciones_publicas` VALUES ('144', ' EDUCACIÓN', ' CENTRO VACACIONAL HUAMPANI (CV HUAMPANI)');
INSERT INTO `instituciones_publicas` VALUES ('145', ' EDUCACIÓN', ' INSTITUCIÓN EDUCATIVA PÚBLICA (CMSPP)');
INSERT INTO `instituciones_publicas` VALUES ('146', ' EDUCACIÓN', ' INSTITUTO NACIONAL DE CULTURA CUSCO (INC-CUSCO)');
INSERT INTO `instituciones_publicas` VALUES ('147', ' EDUCACIÓN', ' INSTITUTO PERUANO DEL DEPORTE (IPD)');
INSERT INTO `instituciones_publicas` VALUES ('148', ' EDUCACIÓN', ' MINISTERIO DE EDUCACIÓN (MINEDU)');
INSERT INTO `instituciones_publicas` VALUES ('149', ' EDUCACIÓN', ' PROGRAMA NACIONAL DE BECAS Y CREDITO EDUCATIVO (PRONABEC)');
INSERT INTO `instituciones_publicas` VALUES ('150', ' EDUCACIÓN', ' PROGRAMA NACIONAL DE INFRAESTRUCTURA EDUCATIVA (PRONIED)');
INSERT INTO `instituciones_publicas` VALUES ('151', ' EDUCACIÓN', ' SECRETARÍA NACIONAL DE LA JUVENTUD (SENAJU)');
INSERT INTO `instituciones_publicas` VALUES ('152', ' EDUCACIÓN', ' SISTEMA NACIONAL DE EVALUACIÓN, ACREDITACIÓN Y CERTIFICACIÓN DE LA CALIDAD EDUCATIVA (SINEACE)');
INSERT INTO `instituciones_publicas` VALUES ('153', ' EDUCACIÓN', ' SUPERINTENDENCIA NACIONAL DE EDUCACION SUPERIOR UNIVERSITARIA (SUNEDU)');
INSERT INTO `instituciones_publicas` VALUES ('154', ' EDUCACIÓN', ' UNIDAD DE GESTIÓN EDUCATIVA LOCAL DANIEL ALCIDES CARRIÓN (UGELDAC)');
INSERT INTO `instituciones_publicas` VALUES ('155', ' EDUCACIÓN', ' UNIDAD DE GESTIÓN EDUCATIVA LOCAL N.º 05 (UGEL 05)');
INSERT INTO `instituciones_publicas` VALUES ('156', ' EDUCACIÓN', ' UNIDAD DE GESTIÓN EDUCATIVA LOCAL N° 01 (UGEL01)');
INSERT INTO `instituciones_publicas` VALUES ('157', ' EDUCACIÓN', ' UNIDAD DE GESTIÓN EDUCATIVA LOCAL N° 02 (UGEL 02)');
INSERT INTO `instituciones_publicas` VALUES ('158', ' EDUCACIÓN', ' UNIDAD DE GESTIÓN EDUCATIVA LOCAL Nº 03 (UGEL Nº 03)');
INSERT INTO `instituciones_publicas` VALUES ('159', ' EDUCACIÓN', ' UNIDAD DE GESTIÓN EDUCATIVA LOCAL Nº 06 (UGEL 06)');
INSERT INTO `instituciones_publicas` VALUES ('160', ' EDUCACIÓN', ' UNIDAD DE GESTION EDUCATIVA LOCAL Nº 07 (UGEL 07)');
INSERT INTO `instituciones_publicas` VALUES ('161', ' MUJER Y POBLACIONES VULNERABLES', ' CONSEJO NACIONAL PARA LA INTEGRACIÓN DE LA PERSONA CON DISCAPACIDAD (CONADIS)');
INSERT INTO `instituciones_publicas` VALUES ('162', ' MUJER Y POBLACIONES VULNERABLES', ' MINISTERIO DE LA MUJER Y POBLACIONES VULNERABLES (MIMP)');
INSERT INTO `instituciones_publicas` VALUES ('163', ' MUJER Y POBLACIONES VULNERABLES', ' PROGRAMA INTEGRAL NACIONAL PARA EL BIENESTAR FAMILIAR (INABIF)');
INSERT INTO `instituciones_publicas` VALUES ('164', ' MUJER Y POBLACIONES VULNERABLES', ' PROGRAMA NACIONAL CONTRA LA VIOLENCIA FAMILIAR Y SEXUAL (PNCVFS)');
INSERT INTO `instituciones_publicas` VALUES ('165', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA DE CHICLAYO (SBCH)');
INSERT INTO `instituciones_publicas` VALUES ('166', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA DE HUANCAYO (SBH)');
INSERT INTO `instituciones_publicas` VALUES ('167', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PÚBLICA DE AREQUIPA (SBPA)');
INSERT INTO `instituciones_publicas` VALUES ('168', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PÚBLICA DE CHACHAPOYAS (SBPCH)');
INSERT INTO `instituciones_publicas` VALUES ('169', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PUBLICA DE ICA (SBPI)');
INSERT INTO `instituciones_publicas` VALUES ('170', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PÚBLICA DE IQUITOS (SBPI)');
INSERT INTO `instituciones_publicas` VALUES ('171', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PUBLICA DE PIURA (SBP - PIURA)');
INSERT INTO `instituciones_publicas` VALUES ('172', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PUBLICA DE TRUJILLO (SBPT)');
INSERT INTO `instituciones_publicas` VALUES ('173', ' MUJER Y POBLACIONES VULNERABLES', ' SOCIEDAD DE BENEFICENCIA PUBLICA DEL CALLAO (SBP-C)');
INSERT INTO `instituciones_publicas` VALUES ('174', ' JUSTICIA', ' INSTITUTO NACIONAL PENITENCIARIO (INPE)');
INSERT INTO `instituciones_publicas` VALUES ('175', ' JUSTICIA', ' MINISTERIO DE JUSTICIA Y DERECHOS HUMANOS (MINJUS)');
INSERT INTO `instituciones_publicas` VALUES ('176', ' JUSTICIA', ' SUPERINTENDENCIA NACIONAL DE LOS REGISTROS PÚBLICOS (SUNARP)');
INSERT INTO `instituciones_publicas` VALUES ('177', ' JUSTICIA', ' ZONA REGISTRAL N° I - SEDE PIURA (ZR - SUNARP)');
INSERT INTO `instituciones_publicas` VALUES ('178', ' JUSTICIA', ' ZONA REGISTRAL N° IX - SEDE LIMA (Z.R.IX)');
INSERT INTO `instituciones_publicas` VALUES ('179', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' AUTORIDAD NACIONAL DEL SERVICIO CIVIL (SERVIR)');
INSERT INTO `instituciones_publicas` VALUES ('180', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' CENTRO NACIONAL DE ESTIMACIÓN, PREVENCIÓN Y REDUCCIÓN DEL RIESGO DE DESASTRES (CENEPRED)');
INSERT INTO `instituciones_publicas` VALUES ('181', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' CENTRO NACIONAL DE PLANEAMIENTO ESTRATÉGICO (CEPLAN)');
INSERT INTO `instituciones_publicas` VALUES ('182', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' COMISIÓN NACIONAL DE BIENES INCAUTADOS (CONABI)');
INSERT INTO `instituciones_publicas` VALUES ('183', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' COMISIÓN NACIONAL PARA EL DESARROLLO Y VIDA SIN DROGAS (DEVIDA)');
INSERT INTO `instituciones_publicas` VALUES ('184', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' CONSEJO NACIONAL DE CIENCIA, TECNOLOGÍA E INNOVACIÓN TECNOLÓGICA (CONCYTEC)');
INSERT INTO `instituciones_publicas` VALUES ('185', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' CUERPO GENERAL DE BOMBEROS VOLUNTARIOS DEL PERÚ (CGBVP)');
INSERT INTO `instituciones_publicas` VALUES ('186', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' DESPACHO PRESIDENCIAL (DP)');
INSERT INTO `instituciones_publicas` VALUES ('187', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' DIRECCIÓN NACIONAL DE INTELIGENCIA (DINI)');
INSERT INTO `instituciones_publicas` VALUES ('188', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' EMPRESA PERUANA DE SERVICIOS EDITORIALES S.A. (EDITORA PERÚ)');
INSERT INTO `instituciones_publicas` VALUES ('189', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' FONDO NACIONAL DE DESARROLLO CIENTÍFICO, TECNOLOGÍCO Y DE INNOVACIÓN TECNOLÓGICA (FONDECYT)');
INSERT INTO `instituciones_publicas` VALUES ('190', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' INSTITUTO NACIONAL DE DEFENSA CIVIL (INDECI)');
INSERT INTO `instituciones_publicas` VALUES ('191', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' INSTITUTO NACIONAL DE DEFENSA DE LA COMPETENCIA Y DE LA PROTECCIÓN DE LA PROPIEDAD INTELECTUAL (IND');
INSERT INTO `instituciones_publicas` VALUES ('192', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' INSTITUTO NACIONAL DE ESTADÍSTICA E INFORMÁTICA (INEI)');
INSERT INTO `instituciones_publicas` VALUES ('193', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' INSTITUTO NACIONAL DE RADIO Y TELEVISIÓN DEL PERÚ (IRTP)');
INSERT INTO `instituciones_publicas` VALUES ('194', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' ORGANISMO DE SUPERVISIÓN DE LOS RECURSOS FORESTALES Y DE FAUNA SILVESTRE (OSINFOR)');
INSERT INTO `instituciones_publicas` VALUES ('195', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' ORGANISMO SUPERVISOR DE INVERSIÓN PRIVADA EN TELECOMUNICACIONES. (OSIPTEL)');
INSERT INTO `instituciones_publicas` VALUES ('196', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' ORGANISMO SUPERVISOR DE LA INVERSION EN ENERGIA Y MINERIA (OSINERGMIN)');
INSERT INTO `instituciones_publicas` VALUES ('197', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' ORGANISMO SUPERVISOR DE LA INVERSION EN INFRAESTRUCTURA DE TRANSPORTE DE USO PÚBLICO (OSITRAN)');
INSERT INTO `instituciones_publicas` VALUES ('198', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' PRESIDENCIA DEL CONSEJO DE MINISTROS (PCM)');
INSERT INTO `instituciones_publicas` VALUES ('199', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' SECRETARIA DE SEGURIDAD Y DEFENSA NACIONAL (SEDENA)');
INSERT INTO `instituciones_publicas` VALUES ('200', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' SIERRA EXPORTADORA');
INSERT INTO `instituciones_publicas` VALUES ('201', ' PRESIDENCIA DEL CONSEJO DE MINISTROS', ' SUPERINTENDENCIA NACIONAL DE SERVICIOS DE SANEAMIENTO (SUNASS)');
INSERT INTO `instituciones_publicas` VALUES ('202', ' RELACIONES EXTERIORES', ' AGENCIA PERUANA DE COOPERACIÓN INTERNACIONAL (APCI)');
INSERT INTO `instituciones_publicas` VALUES ('203', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ALEMANIA (E_ALEMANIA)');
INSERT INTO `instituciones_publicas` VALUES ('204', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ARGENTINA (E_ARGENTINA)');
INSERT INTO `instituciones_publicas` VALUES ('205', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN AUSTRALIA (E_AUSTRALIA)');
INSERT INTO `instituciones_publicas` VALUES ('206', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN AUSTRIA (E-AUSTRIA)');
INSERT INTO `instituciones_publicas` VALUES ('207', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN BÉLGICA (E-BELGICA)');
INSERT INTO `instituciones_publicas` VALUES ('208', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN BOLIVIA (E-BOLIVIA)');
INSERT INTO `instituciones_publicas` VALUES ('209', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN BRASIL (E-BRASIL)');
INSERT INTO `instituciones_publicas` VALUES ('210', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN CANADÁ (E-CANADÁ)');
INSERT INTO `instituciones_publicas` VALUES ('211', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN CHILE (E-CHILE)');
INSERT INTO `instituciones_publicas` VALUES ('212', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN CHINA (E-CHINA)');
INSERT INTO `instituciones_publicas` VALUES ('213', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN COLOMBIA (E-COLOMBIA)');
INSERT INTO `instituciones_publicas` VALUES ('214', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN COSTA RICA (E-COSTARICA)');
INSERT INTO `instituciones_publicas` VALUES ('215', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN CUBA (E-CUBA)');
INSERT INTO `instituciones_publicas` VALUES ('216', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ECUADOR (E-ECUADOR)');
INSERT INTO `instituciones_publicas` VALUES ('217', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN EGIPTO (E-EGIPTO)');
INSERT INTO `instituciones_publicas` VALUES ('218', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN EL SALVADOR (E-ELSALVADOR)');
INSERT INTO `instituciones_publicas` VALUES ('219', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ESPAÑA (E-ESPAÑA)');
INSERT INTO `instituciones_publicas` VALUES ('220', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ESTADOS UNIDOS (E-ESTADOSUNIDOS)');
INSERT INTO `instituciones_publicas` VALUES ('221', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN FINLANDIA (E-FINLANDIA)');
INSERT INTO `instituciones_publicas` VALUES ('222', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN FRANCIA (E-FRANCIA)');
INSERT INTO `instituciones_publicas` VALUES ('223', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN GRAN BRETAÑA (E-GRANBRETAÑA)');
INSERT INTO `instituciones_publicas` VALUES ('224', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN GRECIA (E-GRECIA)');
INSERT INTO `instituciones_publicas` VALUES ('225', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN GUATEMALA (E-GUATEMALA)');
INSERT INTO `instituciones_publicas` VALUES ('226', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN HONDURAS (E-HONDURAS)');
INSERT INTO `instituciones_publicas` VALUES ('227', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN INDIA (E-INDIA)');
INSERT INTO `instituciones_publicas` VALUES ('228', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN INDONESIA (E-INDONESIA)');
INSERT INTO `instituciones_publicas` VALUES ('229', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ISRAEL (E-ISRAEL)');
INSERT INTO `instituciones_publicas` VALUES ('230', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN ITALIA (E-ITALIA)');
INSERT INTO `instituciones_publicas` VALUES ('231', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN JAPÓN (E-JAPÓN)');
INSERT INTO `instituciones_publicas` VALUES ('232', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN LA FEDERACIÓN RUSA (E-FEDERACIONRUSA)');
INSERT INTO `instituciones_publicas` VALUES ('233', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN MALASIA (E-MALASIA)');
INSERT INTO `instituciones_publicas` VALUES ('234', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN MARRUECOS (E-MARRUECOS)');
INSERT INTO `instituciones_publicas` VALUES ('235', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN MÉXICO (E-MÉXICO)');
INSERT INTO `instituciones_publicas` VALUES ('236', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN NICARAGUA (E-NICARAGUA)');
INSERT INTO `instituciones_publicas` VALUES ('237', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN PAISES BAJOS (E-PAISESBAJOS)');
INSERT INTO `instituciones_publicas` VALUES ('238', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN PANAMÁ (E-PANAMÁ)');
INSERT INTO `instituciones_publicas` VALUES ('239', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN PARAGUAY (E-PARAGUAY)');
INSERT INTO `instituciones_publicas` VALUES ('240', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN POLONIA (E-POLONIA)');
INSERT INTO `instituciones_publicas` VALUES ('241', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN PORTUGAL (E-PORTUGAL)');
INSERT INTO `instituciones_publicas` VALUES ('242', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN REPÚBLICA CHECA (E-REPÚBLICACHECA)');
INSERT INTO `instituciones_publicas` VALUES ('243', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN REPÚBLICA DE COREA (E-REPÚBLICACOREA)');
INSERT INTO `instituciones_publicas` VALUES ('244', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN REPUBLICA DOMINICANA (E-REPÚBLICADOMINICAN)');
INSERT INTO `instituciones_publicas` VALUES ('245', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN RUMANIA (E-RUMANIA)');
INSERT INTO `instituciones_publicas` VALUES ('246', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN SANTA SEDE (E-SANTASEDE)');
INSERT INTO `instituciones_publicas` VALUES ('247', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN SINGAPUR (E-SINGAPUR)');
INSERT INTO `instituciones_publicas` VALUES ('248', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN SUDÁFRICA (E-SUDÁFRICA)');
INSERT INTO `instituciones_publicas` VALUES ('249', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN SUECIA (E-SUECIA)');
INSERT INTO `instituciones_publicas` VALUES ('250', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN SUIZA (E-SUISA)');
INSERT INTO `instituciones_publicas` VALUES ('251', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN TAILANDIA (E-TAILANDIA)');
INSERT INTO `instituciones_publicas` VALUES ('252', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN URUGUAY (E-URUGUAY)');
INSERT INTO `instituciones_publicas` VALUES ('253', ' RELACIONES EXTERIORES', ' EMBAJADA DEL PERÚ EN VENEZUELA (E-VENEZUELA)');
INSERT INTO `instituciones_publicas` VALUES ('254', ' RELACIONES EXTERIORES', ' MINISTERIO DE RELACIONES EXTERIORES (RREE)');
INSERT INTO `instituciones_publicas` VALUES ('255', ' DEFENSA', ' AGENCIA DE COMPRAS DE LAS FUERZAS ARMADAS (ACFFAA)');
INSERT INTO `instituciones_publicas` VALUES ('256', ' DEFENSA', ' CAJA DE PENSIONES MILITAR POLICIAL (CPMP)');
INSERT INTO `instituciones_publicas` VALUES ('257', ' DEFENSA', ' COMANDO CONJUNTO DE LAS FUERZAS ARMADAS (CCFFAA)');
INSERT INTO `instituciones_publicas` VALUES ('258', ' DEFENSA', ' COMISIÓN NACIONAL DE INVESTIGACIÓN Y DESARROLLO AEROESPACIAL (CONIDA)');
INSERT INTO `instituciones_publicas` VALUES ('259', ' DEFENSA', ' DIRECCIÓN GENERAL PREVISIONAL DE LAS FFAA (DIGEPREV)');
INSERT INTO `instituciones_publicas` VALUES ('260', ' DEFENSA', ' EJÉRCITO DEL PERÚ (EP)');
INSERT INTO `instituciones_publicas` VALUES ('261', ' DEFENSA', ' ESCUELA NACIONAL DE MARINA MERCANTE (ENAMM)');
INSERT INTO `instituciones_publicas` VALUES ('262', ' DEFENSA', ' FABRICA DE ARMAS Y MUNICIONES DEL EJERCITO S.A.C. (FAME S.A.C.)');
INSERT INTO `instituciones_publicas` VALUES ('263', ' DEFENSA', ' FUERZA AEREA DEL PERÚ (FAP)');
INSERT INTO `instituciones_publicas` VALUES ('264', ' DEFENSA', ' INSTITUTO GEOGRÁFICO NACIONAL (IGN)');
INSERT INTO `instituciones_publicas` VALUES ('265', ' DEFENSA', ' MARINA DE GUERRA DEL PERÚ (MGP)');
INSERT INTO `instituciones_publicas` VALUES ('266', ' DEFENSA', ' MINISTERIO DE DEFENSA (MINDEF)');
INSERT INTO `instituciones_publicas` VALUES ('267', ' DEFENSA', ' SERVICIOS INDUSTRIALES DE LA MARINA (SIMA-PERÚ S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('268', ' DEFENSA', ' SERVICIOS INDUSTRIALES DE LA MARINA IQUITOS S.R.LTDA. (SIMA-IQUITOS S.R.L.)');
INSERT INTO `instituciones_publicas` VALUES ('269', ' INTERIOR', ' MINISTERIO DEL INTERIOR (MININTER)');
INSERT INTO `instituciones_publicas` VALUES ('270', ' INTERIOR', ' OFICINA NACIONAL DE GOBIERNO INTERIOR (ONAGI)');
INSERT INTO `instituciones_publicas` VALUES ('271', ' INTERIOR', ' POLICIA NACIONAL DEL PERÚ (PNP)');
INSERT INTO `instituciones_publicas` VALUES ('272', ' INTERIOR', ' SUPERINTENDENCIA NACIONAL DE CONTROL DE SERVICIOS DE SEGURIDAD, ARMAS, MUNICIONES Y EXPLOSIVOS DE U');
INSERT INTO `instituciones_publicas` VALUES ('273', ' INTERIOR', ' SUPERINTENDENCIA NACIONAL DE MIGRACIONES (MIGRACIONES)');
INSERT INTO `instituciones_publicas` VALUES ('274', ' ECONOMÍA Y FINANZAS', ' AGENCIA DE PROMOCIÓN DE LA INVERSIÓN PRIVADA (PROINVERSION)');
INSERT INTO `instituciones_publicas` VALUES ('275', ' ECONOMÍA Y FINANZAS', ' BANCO DE LA NACIÓN (BN)');
INSERT INTO `instituciones_publicas` VALUES ('276', ' ECONOMÍA Y FINANZAS', ' CONSEJO NACIONAL DE LA COMPETITIVIDAD (CNC)');
INSERT INTO `instituciones_publicas` VALUES ('277', ' ECONOMÍA Y FINANZAS', ' CORPORACIÓN FINANCIERA DE DESARROLLO S.A. (COFIDE)');
INSERT INTO `instituciones_publicas` VALUES ('278', ' ECONOMÍA Y FINANZAS', ' FONDO NACIONAL DE FINANCIAMIENTO DE LA ACTIVIDAD EMPRESARIAL DEL ESTADO (FONAFE)');
INSERT INTO `instituciones_publicas` VALUES ('279', ' ECONOMÍA Y FINANZAS', ' INMOBILIARIA MILENIA S.A. (INMISA)');
INSERT INTO `instituciones_publicas` VALUES ('280', ' ECONOMÍA Y FINANZAS', ' MINISTERIO DE ECONOMÍA Y FINANZAS (MEF)');
INSERT INTO `instituciones_publicas` VALUES ('281', ' ECONOMÍA Y FINANZAS', ' OFICINA DE NORMALIZACIÓN PREVISIONAL (ONP)');
INSERT INTO `instituciones_publicas` VALUES ('282', ' ECONOMÍA Y FINANZAS', ' ORGANISMO SUPERVISOR DE LAS CONTRATACIONES DEL ESTADO (OSCE)');
INSERT INTO `instituciones_publicas` VALUES ('283', ' ECONOMÍA Y FINANZAS', ' SUPERINTENDENCIA DEL MERCADO DE VALORES (SMV)');
INSERT INTO `instituciones_publicas` VALUES ('284', ' ECONOMÍA Y FINANZAS', ' SUPERINTENDENCIA NACIONAL DE ADUANAS Y DE ADMINISTRACIÓN TRIBUTARIA (SUNAT)');
INSERT INTO `instituciones_publicas` VALUES ('285', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' BANCO DE MATERIALES SAC (BANMAT SAC)');
INSERT INTO `instituciones_publicas` VALUES ('286', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' FONDO DE RECONSTRUCCIÓN INTEGRAL DE LAS ZONAS AFECTADAS POR LOS SISMOS DEL 15 DE AGOSTO DE 2007 (FO');
INSERT INTO `instituciones_publicas` VALUES ('287', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' FONDO MIVIVIENDA S. A. (FMV S.A.)');
INSERT INTO `instituciones_publicas` VALUES ('288', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' MINISTERIO DE VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO (VIVIENDA)');
INSERT INTO `instituciones_publicas` VALUES ('289', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' ORGANISMO DE FORMALIZACIÓN DE LA PROPIEDAD INFORMAL (COFOPRI)');
INSERT INTO `instituciones_publicas` VALUES ('290', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' PROGRAMA NACIONAL DE SANEAMIENTO RURAL (PNSR)');
INSERT INTO `instituciones_publicas` VALUES ('291', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' PROGRAMA NACIONAL DE SANEAMIENTO URBANO (PNSU)');
INSERT INTO `instituciones_publicas` VALUES ('292', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' SERVICIO DE AGUA POTABLE Y ALCANTARILLADO DE LIMA (SEDAPAL)');
INSERT INTO `instituciones_publicas` VALUES ('293', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' SERVICIO NACIONAL DE CAPACITACIÓN PARA LA INDUSTRIA DE LA CONSTRUCCIÓN (SENCICO)');
INSERT INTO `instituciones_publicas` VALUES ('294', ' VIVIENDA, CONSTRUCCIÓN Y SANEAMIENTO', ' SUPERINTENDENCIA NACIONAL DE BIENES ESTATALES (SBN)');
INSERT INTO `instituciones_publicas` VALUES ('295', ' AMBIENTE', ' INSTITUTO GEOFÍSICO DEL PERÚ (IGP)');
INSERT INTO `instituciones_publicas` VALUES ('296', ' AMBIENTE', ' MINISTERIO DEL AMBIENTE (MINAM)');
INSERT INTO `instituciones_publicas` VALUES ('297', ' AMBIENTE', ' ORGANISMO DE EVALUACIÓN Y FISCALIZACIÓN AMBIENTAL (OEFA)');
INSERT INTO `instituciones_publicas` VALUES ('298', ' AMBIENTE', ' PROGRAMA CONSERVACIÓN DE BOSQUES (PNCBMCC)');
INSERT INTO `instituciones_publicas` VALUES ('299', ' AMBIENTE', ' SERVICIO NACIONAL DE ÁREAS NATURALES PROTEGIDAS POR EL ESTADO (SERNANP)');
INSERT INTO `instituciones_publicas` VALUES ('300', ' AMBIENTE', ' SERVICIO NACIONAL DE CERTIFICACIÓN AMBIENTAL PARA LAS INVERSIONES SOSTENIBLES (SENACE)');
INSERT INTO `instituciones_publicas` VALUES ('301', ' AMBIENTE', ' SERVICIO NACIONAL DE METEOROLOGIA E HIDROLOGIA DEL PERÙ (SENAMHI)');
INSERT INTO `instituciones_publicas` VALUES ('302', ' CULTURA', ' ARCHIVO GENERAL DE LA NACIÓN (AGN)');
INSERT INTO `instituciones_publicas` VALUES ('303', ' CULTURA', ' BIBLIOTECA NACIONAL DEL PERÚ (BNP)');
INSERT INTO `instituciones_publicas` VALUES ('304', ' CULTURA', ' MINISTERIO DE CULTURA (CULTURA)');
INSERT INTO `instituciones_publicas` VALUES ('305', ' CULTURA', ' UNIDAD EJECUTORA 002 MC-CUSCO (DDC-CUSCO)');
INSERT INTO `instituciones_publicas` VALUES ('306', ' CULTURA', ' UNIDAD EJECUTORA 003 - ZONA ARQUEOLÓGICA CARAL/MC (UE003-ZAC/MC)');
INSERT INTO `instituciones_publicas` VALUES ('307', ' CULTURA', ' UNIDAD EJECUTORA 006 - PROYECTO ESPECIAL COMPLEJO ARQUEOLÓGICO CHAN CHAN (UE 006 CHAN CHAN)');
INSERT INTO `instituciones_publicas` VALUES ('308', ' CULTURA', ' UNIDAD EJECUTORA 007 MARCAHUAMACHUCO (U.E. 007)');
INSERT INTO `instituciones_publicas` VALUES ('309', ' CULTURA', ' UNIDAD EJECUTORA N° 004 - INDEPA (UE-004 - INDEPA)');
INSERT INTO `instituciones_publicas` VALUES ('310', ' DESARROLLO E INCLUSIÓN SOCIAL', ' FONDO DE COOPERACIÓN PARA EL DESARROLLO SOCIAL (FONCODES)');
INSERT INTO `instituciones_publicas` VALUES ('311', ' DESARROLLO E INCLUSIÓN SOCIAL', ' MINISTERIO DE DESARROLLO E INCLUSIÓN SOCIAL (MIDIS)');
INSERT INTO `instituciones_publicas` VALUES ('312', ' DESARROLLO E INCLUSIÓN SOCIAL', ' PROGRAMA NACIONAL CUNA MÁS (PNCM)');
INSERT INTO `instituciones_publicas` VALUES ('313', ' DESARROLLO E INCLUSIÓN SOCIAL', ' PROGRAMA NACIONAL DE ALIMENTACIÓN ESCOLAR - QALI WARMA (PNAE - QALI WARMA)');
INSERT INTO `instituciones_publicas` VALUES ('314', ' DESARROLLO E INCLUSIÓN SOCIAL', ' PROGRAMA NACIONAL DE APOYO DIRECTO A LOS MÁS POBRES - JUNTOS (JUNTOS)');
INSERT INTO `instituciones_publicas` VALUES ('315', ' DESARROLLO E INCLUSIÓN SOCIAL', ' PROGRAMA NACIONAL DE ASISTENCIA ALIMENTARIA (PRONAA)');
INSERT INTO `instituciones_publicas` VALUES ('316', ' DESARROLLO E INCLUSIÓN SOCIAL', ' PROGRAMA NACIONAL DE ASISTENCIA SOLIDARIA PENSIÓN 65 (PENSION 65)');
INSERT INTO `instituciones_publicas` VALUES ('317', ' SALUD', ' HOSPITAL BARRANCA CAJATAMBO Y SBS (HBC-SBS)');
INSERT INTO `instituciones_publicas` VALUES ('318', ' SALUD', ' HOSPITAL CHANCAY (HCHC)');
INSERT INTO `instituciones_publicas` VALUES ('319', ' SALUD', ' HOSPITAL DE SICUANI - CUSCO (HSC)');
INSERT INTO `instituciones_publicas` VALUES ('320', ' SALUD', ' HOSPITAL NACIONAL GENERAL (HNGAL)');
INSERT INTO `instituciones_publicas` VALUES ('321', ' SALUD', ' INSTITUTO DE DESARROLLO DE RECURSOS HUMANOS (IDREH)');
INSERT INTO `instituciones_publicas` VALUES ('322', ' CULTURA', ' UNIDAD EJECUTORA 005 PROYECTO ESPECIAL NAYLAMP - LAMBAYEQUE (U.E. 005)');
...
CREATE TABLE `tipo_cursos` (
  ...
  `estado` int(11) DEFAULT NULL,
  `color_tr` varchar(20) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `tipo_cursos` VALUES ('1', 'Cursos de Estadistica', '1', 'yellowgreen');
INSERT INTO `tipo_cursos` VALUES ('2', 'Cursos de Economia', '1', 'gold');
INSERT INTO `tipo_cursos` VALUES ('3', 'Cursos de Software Estadístico', '1', 'aqua');
INSERT INTO `tipo_cursos` VALUES ('4', 'Cursos de Informática', '1', 'lightblue');
INSERT INTO `tipo_cursos` VALUES ('5', 'Cursos de Especialización', '1', 'antiquewhite');
...
CREATE TABLE `ubprovincia` (
  ...
  PRIMARY KEY (`idProv`),
  KEY `fk_ubprovincia_ubdepartamento1_idx` (`idDepa`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`us_encuesta_cap`@`%` SQL SECURITY DEFINER VIEW `cursos_by_persona` AS select `tc`.`color_tr` AS `color_tr`,`tc`.`idtipo_cursos` AS `idtipo_cursos`,`tc`.`nombre_tipo` AS `nombre_tipo`,`cp`.`id_cursos` AS `id_cursos`,`c`.`descripcion_curso` AS `descripcion_curso`,`cp`.`id_persona` AS `id_persona` from ((`cursos_has_datos_personales` `cp` join `cursos` `c` on((`c`.`id_cursos` = `cp`.`id_cursos`))) join `tipo_cursos` `tc` on((`tc`.`idtipo_cursos` = `c`.`idtipo_cursos`))) order by `cp`.`id_cursos` ;

-- ----------------------------
-- View structure for `dist_by_provincia_by_dpto`
-- ----------------------------
DROP VIEW IF EXISTS `dist_by_provincia_by_dpto`;
CREATE ALGORITHM=UNDEFINED DEFINER=`us_encuesta_cap`@`%` SQL SECURITY DEFINER VIEW `dist_by_provincia_by_dpto` AS select `ud`.`idDist` AS `idDist`,`ud`.`distrito` AS `distrito`,`ud`.`idProv` AS `idProv`,`up`.`provincia` AS `provincia`,`up`.`idDepa` AS `idDepa`,`udp`.`departamento` AS `departamento` from ((`ubdistrito` `ud` join `ubprovincia` `up` on((`ud`.`idProv` = `up`.`idProv`))) join `ubdepartamento` `udp` on((`udp`.`idDepa` = `up`.`idDepa`))) ;

-- ----------------------------
-- View structure for `persona_by_ubigeo`
-- ----------------------------
DROP VIEW IF EXISTS `persona_by_ubigeo`;
CREATE ALGORITHM=UNDEFINED DEFINER=`us_encuesta_cap`@`%` SQL SECURITY DEFINER VIEW `persona_by_ubigeo` AS select `dp`.`id_persona` AS `id_persona`,`dp`.`nombres` AS `nombres`,`dp`.`appat` AS `appat`,`dp`.`apmat` AS `apmat`,`dp`.`correo` AS `correo`,`dp`.`telefono` AS `telefono`,`dp`.`celular` AS `celular`,`dp`.`edad` AS `edad`,`dp`.`sexo` AS `sexo`,`dp`.`idDist` AS `idDist`,`dp`.`idinstituciones_publicas` AS `idinstituciones_publicas`,`dp`.`area` AS `area`,`dp`.`sugerencias` AS `sugerencias`,`vdpd`.`distrito` AS `distrito`,`vdpd`.`idProv` AS `idProv`,`vdpd`.`provincia` AS `provincia`,`vdpd`.`idDepa` AS `idDepa`,`vdpd`.`departamento` AS `departamento` from (`datos_personales` `dp` join `dist_by_provincia_by_dpto` `vdpd` on((`dp`.`idDist` = `vdpd`.`idDist`))) ;
